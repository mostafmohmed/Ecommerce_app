<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-dark navbar-shadow">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="{{asset('dash/app-assets')}}/images/slider/slider-2.png"
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  <img src="{{asset('dash/app-assets')}}/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
              </a>
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i class="ft-user"></i> Edit Profile</a>
                ...
                <form action="{{route('dashpoard.logout')}}" method="post">
                    @csrf
                    {{-- <button> </button> --}}
                    <button class="dropdown-item" href="#"><i class="ft-power"></i> Logout</button>
                </form>
            ...
            <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                ...
                <a class="dropdown-item"  rel="alternate" hreflang="{{ $localeCode }}"   href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"><i class="flag-icon @if($localeCode == 'en') flag-icon-gb @else flag-icon-eg @endif "></i> {{ $properties['native'] }}</a>
                @endforeach
              </div>
            </li>
            <li class="dropdown dropdown-notification nav-item">
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  ...
                  <span class="notification-tag badge badge-default badge-danger float-right m-0" id="count"></span>
                </li>
                @php
                ...
                <li class="scrollable-container media-list w-100" id="notif-list">
                  ...
                  @if ($notification->type=='App\Models\Admin')
                        <a href="{{  route('website.order.show',$notification->data['order_id']) }}?notify_admin={{$notification->id}}">
                    <div class="media">
    ...
    EGP {{$notification->data['total_price']}}
                        ...
                        <small>
                          <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">        {{ $notification->created_at->locale(app()->getLocale())->diffForHumans() }}
</time>
                        </small>
                      </div>
                    </div>
                ...
                <li class="scrollable-container media-list w-100">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{asset('dash/app-assets')}}/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('dash/app-assets')}}/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{asset('dash/app-assets')}}/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
