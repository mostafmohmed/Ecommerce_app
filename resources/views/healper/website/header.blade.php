<header id="header" class="header">
    ...
    <div class="header-center-section d-none d-lg-block">
        ...
        <a href="{{route('website.cart.index')}}" class="cart-item">
        <span>
        ...
        <h5 class="wrapper-title"></h5>
        </div>
        <div class="cart-btn">
        <a href="cart.html" class="shop-btn view-btn">View Cart</a>
        <a href="{{route('website.checkout.create')}}" class="shop-btn checkout-btn">Checkout Now</a>
        </div>
        </div>
        </div>
        </div>
