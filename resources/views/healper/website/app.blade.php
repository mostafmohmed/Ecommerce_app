...
<link rel="stylesheet" href="{{asset('website/css')}}/swiper10-bundle.min.css">

<link rel="stylesheet" href="{{asset('website/css')}}/bootstrap-5.3.2.min.css">
...
<body>
 ...
 @include('healper.website.header')
