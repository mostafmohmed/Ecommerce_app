...
// }
                ...
                $.ajax({
                    url: "{{ route('website.contact.store') }}", // Route to the controller method
                   method:'POST',
                    data: formData,
...
if(error["phone"]){
    ...
    $('#phone').addClass('is-invalid').siblings('p').addClass('invalid-feedback').text(error["phone"]);
    
   }
   
   else{
    $('#phone').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').text(' ');
   }
...
console.log(error["name"]);
    ...
    $('#name').addClass('is-invalid').siblings('p').addClass('invalid-feedback').text(error["name"]);
...
//    }
   ...
   if(error["email"]){
    ...
    $('#email').addClass('is-invalid').siblings('p').addClass('invalid-feedback').text(error["email"]);
    statud1= false; 
    console.log(statud1);
}
if(!error["email"]){
...
if(error["email"]){
   ...
   if(error["massage"]){
    ...
    $('#massage').addClass('is-invalid').siblings('p').addClass('invalid-feedback').text(error["massage"]);
    
   }
   
   else{
    $('#massage').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').text(' ');
   }

   if(error["subject"]){


$('#subject').addClass('is-invalid').siblings('p').addClass('invalid-feedback').text(error["subject"]);

}

else{
$('#subject').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').text(' ');
}
...
console.log(formData);
    ...
    //     console.log(fieldValue);
        ...
        $.ajax({
                    url: "{{route('website.contact.validtion')}}",
                    method: 'POST',
                    data: formData,
