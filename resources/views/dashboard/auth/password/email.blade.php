...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('dash')}}/app-assets/css-rtl/core/menu/menu-types/vertical-menu-modern.css">
  <link rel="stylesheet" type="text/css" href="{{asset('dash')}}/app-assets/css-rtl/core/colors/palette-gradient.css">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
...
data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal" action="{{route('dashpoard.sendotp')}}" method="POST" novalidate>
                        @csrf
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="email" class="form-control form-control-lg input-lg" id="user-email"
                ...
                <div class="card-footer border-0">
                  <p class="float-sm-left text-center"><a href="{{ route('dashpoard.login')}}" class="card-link">Login</a></p>
  ...
  <script src="{{asset('dash')}}/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js"
  ...
  <!-- END MODERN JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="{{asset('dash')}}/app-assets/js/scripts/forms/form-login-register.js" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
</body>
</html>