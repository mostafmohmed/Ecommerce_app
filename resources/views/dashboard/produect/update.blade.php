            ...
            <div class="row">
                <div class="col-md-4 mr-4">
                    <div class="form-group">
                        ...
                        <input  type="text" class="form-control"  value="{{$produect->getTranslation('name','ar')}}" name="name[ar]" id="name_ar"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input  type="text" class="form-control"   value="{{$produect->getTranslation('name','en')}}"  name="name[en]" id="name_en"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="emailAddress3"> {{ __('dashboard.small_description_ar') }}
                            :</label>
                        <textarea name="small_desc[ar]"   class="form-control" id="small_desc_ar">{{$produect->getTranslation('small_desc','ar')}}</textarea>
                       <p></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="emailAddress3"> {{ __('dashboard.small_description_en') }}
                            :</label>
                        <textarea name="small_desc[en]" class="form-control" id="small_desc_en">{{$produect->getTranslation('small_desc','en')}}</textarea>
                     <P></P>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="desc[ar]" class="form-control" id="desc_ar">{{$produect->getTranslation('desc','ar')}}</textarea>
                      <p></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="desc[en]" class="form-control" id="desc_en">{{$produect->getTranslation('desc','en')}}</textarea>
                      <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control custom-select" id="category_id">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" @selected($produect->category->id==  $category->id)>{{ $category->name }}</option>
                            @endforeach
                        </select>
                       <p></p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="brand_id" class="form-control custom-select" id="brand_id">
                            ...
                            @foreach ($brands as $brand)
                                <option value="{{ $brand->id }}"     @selected($produect->brand->id==  $brand->id) >{{ $brand->name }}</option>
                            @endforeach
                        </select>
                       <p></p>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="sku" type="text"  value="{{$produect->sku}}" class="form-control" id="sku">
                       <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="available_for" type="date" value="{{$produect->available_for}}" class="form-control" id="available_for">
                        <p></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="tags" id="tags" value="{{$produect->tags}}" class="form-control"
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select name="has_variants" id="has_variants" name="has_variants"
                                class="form-control">
                        ...
                        <div class="col-6 priceclass  ">
                            <div class="form-group">
                                <label for="price">{{ __('dashboard.price') }} :</label>
                                <input type="number" class="form-control" name="price" id="price"
                                    name="price" placeholder="{{ __('dashboard.price') }}">
                               <p></p>
                            </div>
                        </div>
                        <div class="col-6 manage_stockclass ">
                            <div class="form-group">
                        ...
                        <div class="col-6 quantityclass">
                            <div class="form-group">
                                <label for="quantity">{{ __('dashboard.quantity') }} :</label>
                                <input type="number" class="form-control" name="quantity" id="quantity"
                                    name="quantity" placeholder="{{ __('dashboard.quantity') }}">
                              <p></p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select  id="has_discount" class="form-control" name="has_discount">
                        ...
                        <div class="col-6 start_discount">
                            <div class="form-group">
                        ...
                        <div class="col-6 end_discount">
                            <div class="form-group end_discount">
                    ...
                    {{-- @endif --}}
                        <div>
                            <a  class="add_more_ed">add_more_ed</a>
                         
                        </div>
                    </div>
<div class="attributevaluesContainer" ></div>
<div class="attributevaluesContainers" ></div>
...
$('#image').fileinput({
            ...
            initialPreview: [
                @if ($produect->images->count() > 0)
                    @foreach ($produect->images as $image)
                        "{{ asset('uploads/produect/'.$image->file_name) }}",
                    @endforeach
                @endif
            ],
            initialPreviewConfig: [
                @if($produect->images->count() > 0)
                    @foreach ($produect->images as $image)
                        {
                            caption: "{{  asset('uploads/produect/'.$image->file_name) }}",
                            width: '120px',
                            url: "{{ route('dashpoard.produect.image.delete' , [$image->id , '_token'=>csrf_token()]) }}",
                            key: "{{ $image->id }}",
...
let variantAttributes =@json( $variantAttributes);
console.log(variantAttributes);

 var lang = "{{ app()->getLocale() }}";
let rowvalue="{{$valueRowCount}}";
let variants= @json($variants);
let productAttributes=@json($productAttributes);
let has_variants=@json($produect->has_variants);
let manage_stock=@json($produect->manage_stock);
let  has_discount=@json($produect->has_discount);
let attrvalue = @json($Attribute); 
if (!has_variants && manage_stock ) {
    $(".quantityclass").show(); 
}else{
    $(" .quantityclass").hide(); 
}
...
// let attrvalue = @json($variants);  // Laravel Blade will encode the value as JSON
...
if (has_variants==1) {
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input name="prices[${index}]" type="number" value="${variants.price}" class="form-control" placeholder="Product Price">
                    <p></p>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input name="quantities[${index}]" type="number" value="${variants.stock}" class="form-control" placeholder="Product Quantity">
                    <p></p>
                </div>
            </div>`;
    ...
    if (productAttributes.length > 0 && Array.isArray(productAttributes)) {
        for (let i= 0; i < productAttributes.length; i++) {
            let attrname = lang === 'en' ? productAttributes[i].name.en : productAttributes[i].name.ar;
              lhtml += `
            <div class="col-3">
                <div class="form-group">
                    <label for="price">${attrname}</label>
                    <select name="attributevalues[${index}][${productAttributes[i].id}]" class="form-control">
                        <option value="" selected>Select</option>`;
            
                        productAttributes[i].attributrvalues.forEach(attributevalue => {
                let optionvalue = lang === 'en' ? attributevalue.value.en : attributevalue.value.ar;
                let selected = (variantAttributes[index] && variantAttributes[index][productAttributes[i].id] === attributevalue.id) ? "selected" : "";
                // console.log(variantAttributes[index]);
                // console.log(attributevalue.id);
                
                lhtml += `<option value="${attributevalue.id}" ${selected}>${optionvalue}</option>`;
            });
    ...
    $('.attributevaluesContainer:last').after(lhtml);
...
console.log(len);
    ...
    // Append the generated row to the container
    $('.attributevaluesContainers:last').after(len);
});
