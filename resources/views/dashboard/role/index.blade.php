        ...
        <div class="content-body">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <a href="{{ route('dashpoard.Role.create') }}" class="btn btn-primary">{{ __('dashboard.add') }}</a><br><br>
                            ...
                            <tbody>
                                ...
                                @forelse ($roles as $role)
                                            ...
                                            <div class="dropdown float-md-left">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                                                    <a class="dropdown-item"
                                                        href="{{ route('dashpoard.Role.edit', $role->id) }}"><i
                                    ...
                                    <form id="delete-form-{{ $role->id }}"
                                        action="{{ route('dashpoard.Role.destroy', $role->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                    </form>
