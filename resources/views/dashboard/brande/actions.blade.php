<div class="form-group">
    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
      <a type="button" href="{{route('dashpoard.Brande.edit',$brand->id)}}" class="btn btn-outline-success">{{__('dashboard.edit')}} <li class="la la-edit" ></li></a>
      ...
      <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
            <form action="{{route('dashpoard.Brande.edit',$brand->id)}}" method="post">
                @csrf
                @method('DELETE')
