                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashpoard.Brande.index') }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('dashpoard.Brande.update', $brande->id) }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    @method('PUT')

                                    <input name="id" value="{{ $brande->id }}" type="hidden">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $brande->getTranslation('name', 'en') }}" class="form-control"
                                        ...
                                        <div class="col md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $brande->getTranslation('name', 'ar') }}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" value="" class="form-control" id="single-image"
                                                placeholder="{{ __('dashboard.image') }}" name="logo">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="d-inline-block custom-control custom-radio mr-1">
                                                    <input type="radio" value="1" @checked($brande->status == 1) name="status" class="custom-control-input"
                                                        id="yes1">
                                                    <label class="custom-control-label" for="yes1">{{ __('dashboard.active') }}</label>
                                                </div>
                                                <div class="d-inline-block custom-control custom-radio">
                                                    <input type="radio" value="0" @checked($brande->status==0)  name="status" class="custom-control-input"
                                                        id="no1">
